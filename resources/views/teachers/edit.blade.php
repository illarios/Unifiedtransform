            ...
            <div class="row pt-2">
                <div class="col ps-4">
                    <h1 class="display-6 mb-3">
                        <i class="bi bi-person-lines-fill"></i> Επεξεργασία Δασκάλου
                    </h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{route('home')}}">Αρχική</a></li>
                            <li class="breadcrumb-item"><a href="{{url()->previous()}}">Λίστα Δασκάλων</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Επεξεργασία Δασκάλου</li>
                        </ol>
                    </nav>
                        ...
                        <form class="row g-3" action="{{route('school.teacher.update')}}" method="POST">
                            ...
                            <div class="col-2">
                                ...
                                <select id="inputState" class="form-select" name="gender" required>
                                    <option value="Male" {{($teacher->gender == 'Male')?'selected':null}}>Άνδρας</option>
                                    <option value="Female" {{($teacher->gender == 'Female')?'selected':null}}>Γυναίκα</option>
                                </select>
                            </div>
                            <div class="col-3">
                            ...
                            <div class="col-12">
                                <button type="submit" class="btn btn-sm btn-outline-primary"><i class="bi bi-person-check"></i> Ενημέρωση</button>
                            </div>
                        </form>
                    </div>
                </div>
