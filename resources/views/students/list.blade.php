            ...
            <div class="row pt-2">
                <div class="col ps-4">
                    <h1 class="display-6 mb-3">
                        <i class="bi bi-person-lines-fill"></i> Λίστα Μαθητών
                    </h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{route('home')}}">Αρχική</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Λίστα Μαθητών</li>
                        </ol>
                    </nav>
                    @include('session-messages')
                    <h6>Φίλτρα Λίστας Μαθητών:</h6>
                    <div class="mb-4 mt-4">
                        ...
                        @foreach ($studentList as $student)
                            @if ($loop->first)
                                <p class="mt-3"><b>Τμήμα:</b> {{$student->section->section_name}}</p>
                                @break
                            @endif
                        @endforeach
